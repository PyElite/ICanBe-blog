jQuery(function(t) {
    ...
    customModalTemplate = {
        ...
        Download: function(t) {
            return '\n     <div class="download-box"> <p class="dl-info"> <i class="fa fa-key" aria-hidden="true"></i> 查看密码： <b class="dl-psw">' + t.info + '</b> </p> <a class="btn btn-lg btn-primary" href="' + t.url + '" target="_blank" rel="nofollow"><i class="fa fa-cloud-download" aria-hidden="true"></i> 前往下载页面</a><p class="desc">若当前下载地址失效请联系站长更新</p> </div>  \n'
        },
        Popup: function(t) {
